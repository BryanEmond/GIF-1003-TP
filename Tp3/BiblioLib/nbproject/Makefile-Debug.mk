...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libbibliolib.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libbibliolib.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libbibliolib.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libbibliolib.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libbibliolib.a

${OBJECTDIR}/Bibliographie.o: Bibliographie.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Bibliographie.o Bibliographie.cpp
...
${OBJECTDIR}/Journal.o: Journal.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Journal.o Journal.cpp

${OBJECTDIR}/Ouvrage.o: Ouvrage.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ouvrage.o Ouvrage.cpp
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/BibliographieTesteur.o ${TESTDIR}/JournalTesteur.o ${TESTDIR}/tests/OuvrageTesteur.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/tests/BibliographieTesteur.o: tests/BibliographieTesteur.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BibliographieTesteur.o tests/BibliographieTesteur.cpp


${TESTDIR}/JournalTesteur.o: JournalTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/JournalTesteur.o JournalTesteur.cpp


${TESTDIR}/tests/OuvrageTesteur.o: tests/OuvrageTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/OuvrageTesteur.o tests/OuvrageTesteur.cpp
...
${OBJECTDIR}/Bibliographie_nomain.o: ${OBJECTDIR}/Bibliographie.o Bibliographie.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Bibliographie_nomain.o Bibliographie.cpp;\
	else  \
...
${OBJECTDIR}/Journal_nomain.o: ${OBJECTDIR}/Journal.o Journal.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Journal_nomain.o Journal.cpp;\
	else  \
...
${OBJECTDIR}/Ouvrage_nomain.o: ${OBJECTDIR}/Ouvrage.o Ouvrage.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ouvrage_nomain.o Ouvrage.cpp;\
	else  \
...
${OBJECTDIR}/gestionReferences_nomain.o: ${OBJECTDIR}/gestionReferences.o gestionReferences.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/gestionReferences.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestionReferences_nomain.o gestionReferences.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/gestionReferences.o ${OBJECTDIR}/gestionReferences_nomain.o;\
	fi
