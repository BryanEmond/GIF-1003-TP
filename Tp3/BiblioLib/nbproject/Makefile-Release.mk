...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bibliolib

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bibliolib: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bibliolib ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/gestionReferences.o: gestionReferences.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestionReferences.o gestionReferences.cpp
...
${OBJECTDIR}/gestionReferences_nomain.o: ${OBJECTDIR}/gestionReferences.o gestionReferences.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gestionReferences_nomain.o gestionReferences.cpp;\
	else  \
