...
int main(int argc, char** argv)
{
    ...
    cout << endl;
    //    std::string id = "ISSN 9999-1111";
    //    Journal jou("auteur", "titre", 2005, id, "nom", 1, 1, 200);
    //    Bibliographie biblio("biblio1");
    //    biblio.ajouterReference(jou);
    //    cout << biblio.reqBibliographieFormate() << std::endl;
    //    biblio.supprimerReference(id);
    //
    //    cout << biblio.reqBibliographieFormate() << std::endl;
    //    cout << "allo" << std::endl;

    //    biblio.supprimerReference("ISSN 9999-1111");
    //
    //    cout << biblio.reqBibliographieFormate();
